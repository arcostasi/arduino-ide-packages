...
void delayMicroseconds(unsigned int us)
{
  ...
  #define _MORENOP_ " nop \n\t  nop \n\t"
    ...
    // For a 1 to 3 microsecond delay, simply return.
    // The overhead of the function call takes 14 (16) cycles, which is 2.5us
  ...
  #define _MORENOP_ " nop \n\t  nop \n\t"
    ...
    // for a 1 to 4 microsecond delay, simply return.
    // The overhead of the function call takes 14 (16) cycles, which is 4us
    ...
    // for a 1 to 9 microsecond delay, simply return.
    // The overhead of the function call takes 14 (16) cycles, which is 8us
...
// This clears up the timer settings, and then calls the tone timer
// initialization function (unless it's been disabled - but in this case,
// whatever called this isn't working anyway!
